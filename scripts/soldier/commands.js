...
function registerSoldierCommands(registry) {
    ...
    registry.registerCommand({
        ...
        mandatoryParameters: [{ type: CustomCommandParamType.Location, name: "Target" }]
    }, (origin, target) => {
        const player = playerOnly(origin);
        if (!player) return result(false);
        return result(commandMove(nearestOwnedSoldier(player), target));
    });
    ...
    registry.registerCommand({
        ...
        const player = playerOnly(origin);
        if (!player) return result(false);
        return result(commandFollow(nearestOwnedSoldier(player)));
    });
    ...
    registry.registerCommand({
        ...
        const player = playerOnly(origin);
        if (!player) return result(false);
        return result(commandStay(nearestOwnedSoldier(player)));
    });
    ...
    registry.registerCommand({
        ...
        description: "Erstellt eine Gruppe aus eigenen Soldaten in der Nähe",
        permissionLevel: CommandPermissionLevel.GameDirectors,
        cheatsRequired: false,
    ...
    registry.registerCommand({
        ...
        description: "Fügt den nächsten eigenen Soldaten einer Gruppe hinzu",
        permissionLevel: CommandPermissionLevel.GameDirectors,
        cheatsRequired: false,
    ...
    registry.registerCommand({
        ...
        description: "Entfernt den nächsten eigenen Soldaten aus einer Gruppe",
        permissionLevel: CommandPermissionLevel.GameDirectors,
        cheatsRequired: false,
        mandatoryParameters: [{ type: CustomCommandParamType.String, name: "Group" }]
    }, (origin, name) => {
    ...
    registry.registerCommand({
        ...
        description: "Löscht eine eigene Soldatengruppe",
        permissionLevel: CommandPermissionLevel.GameDirectors,
        cheatsRequired: false,
        mandatoryParameters: [{ type: CustomCommandParamType.String, name: "Group" }]
    }, (origin, name) => {
    ...
    registry.registerCommand({
        ...
        description: "Lässt eine Gruppe dem Spieler in Formation folgen",
        permissionLevel: CommandPermissionLevel.GameDirectors,
        cheatsRequired: false,
        mandatoryParameters: [{ type: CustomCommandParamType.String, name: "Group" }]
    }, (origin, name) => {
    ...
    registry.registerCommand({
        ...
        description: "Lässt eine Gruppe an ihrer Position bleiben",
        permissionLevel: CommandPermissionLevel.GameDirectors,
        cheatsRequired: false,
        mandatoryParameters: [{ type: CustomCommandParamType.String, name: "Group" }]
    }, (origin, name) => {
    ...
    registry.registerCommand({
        ...
        description: "Lässt eine Gruppe einen Bereich verteidigen",
        permissionLevel: CommandPermissionLevel.GameDirectors,
        cheatsRequired: false,
        mandatoryParameters: [
            { type: CustomCommandParamType.String, name: "Group" },
    ...
    registry.registerCommand({
        ...
        description: "Ändert die Formation einer Gruppe",
        permissionLevel: CommandPermissionLevel.GameDirectors,
        cheatsRequired: false,
        mandatoryParameters: [
            { type: CustomCommandParamType.String, name: "Group" },
    ...
    registry.registerCommand({
        ...
        permissionLevel: CommandPermissionLevel.GameDirectors,
        cheatsRequired: false,
        mandatoryParameters: [{ type: CustomCommandParamType.String, name: "Type" }],
