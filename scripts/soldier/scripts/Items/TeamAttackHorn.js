        ...
        onUse(event) {
            ...
            system.run(() => {
                ...
                const nearbyEntities = player.dimension.getEntities({
                    location: origin, maxDistance: 60, families: ["irongolem"],
                    propertyOptions: [{ propertyId: "fv:kill_player_mode", value: { equals: targetPropertyModeValue } }]
                });
                ...
                for (const ent of nearbyEntities) {
                    ...
                    if (isMine) {
                        try { ent.setProperty("fv:kill_player_mode", setPropertyToValue); } catch (e) { }
                    }
                }
