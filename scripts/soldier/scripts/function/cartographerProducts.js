...
system.afterEvents.scriptEventReceive.subscribe((event) => {
    ...
    if (level === 0) {
        ...
        // According to progression 1, 1, 2, 3... level 5 receives 4 maps
    ...
    // 2. Paper -> Paper writable (fv:paper_writable) [1:1]
